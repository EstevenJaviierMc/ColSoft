...
public class ControladorProgramaAcademico extends ConectarBD {
    ...
    public boolean registrar(ProgramaAcademico pro, Facultad f) throws SQLException {
        ...
        String query = "INSERT INTO programaacademico (Codigo,nombrePrograma,idFacultad,estado) VALUES(?,?,?,?)";
        try {

            ps = this.getCon().prepareStatement("INSERT INTO programaacademico VALUES(?,?,?,?,?)");
            ps.setString(1, null);
            ps.setString(2, pro.getCodigo());
            ps.setString(3, pro.getNombreprograma());
            ps.setInt(4, f.getIdFacultad());
    ...
    private ProgramaAcademico load(ResultSet et) throws SQLException {
        ...
        pro.setCodigo(et.getString(2));
        pro.setNombreprograma(et.getString(3));
        f.setIdFacultad(et.getInt(4));
        pro.setIdfacultad(f);
        pro.setEstado(et.getString(5));
